...
wallet = stat(6)
if wallet == "unsynced" or wallet == "false" or wallet == "" or wallet == "null" then
 seed = abs(rnd(-1))
...
red_check = red_check or sub(tostr(seed),-4,-1) == "9998"
red_check = red_check or sub(tostr(seed),-4,-1) == "9997"
red_check = red_check or sub(tostr(seed),-4,-1) == "9996"
red_check = red_check or sub(tostr(seed),-4,-1) == "9995"
