...
**Entropy locking** is a technique where the random number generator is periodically reseeded back to its original seed during runtime. This creates a dynamic balance between chaos and order—the system drifts into entropy but keeps getting "pulled back" to its origin point, creating structured decay and controlled chaos.
...
This technique appears throughout the work as both a technical innovation and a conceptual exploration of what entropy *actually is*—not pure disorder, but a tendency toward equilibrium with occasional resistance.
